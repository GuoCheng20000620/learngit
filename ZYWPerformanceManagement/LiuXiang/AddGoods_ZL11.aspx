<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGoods_ZL11.aspx.cs" Inherits="AddGoods_ZL11" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td  colspan="4" style="text-align: center" class="auto-style37">
                    <asp:Label ID="Label1" runat="server" Text="直连品种及用户信息维护" ForeColor="#FF3300" style="font-size: x-large"></asp:Label>
                </td>
            </tr>
            <tr>
    ...
    <table align="center" style="width: 126px">
        <tr>
            <td class="auto-style50">
                <dx:ASPxButton ID="btnAddtolist" runat="server" AutoPostBack="False" Text="添加至己有货品列表" Width="136px"  ClientInstanceName="cin_addlist">
